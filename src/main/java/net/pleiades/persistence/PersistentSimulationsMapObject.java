 ...
 * @author bennie
 */
public class PersistentSimulationsMapObject extends BasicDBObject {

    public PersistentSimulationsMapObject() {
    }

    public PersistentSimulationsMapObject(Simulation s) {
